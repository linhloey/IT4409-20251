				...
				<div style={{ width: '800px', height: '445px', borderRadius: '6px', background: '#fff', display: 'flex'}}>
					<WrapperContainerLeft>
						...
						<div style={{ position: 'relative' }}>
							...
							<InputForm placeholder="confirm password" style={{ marginBottom: '10px' }} type={isShowPassword ? "text" : "confirm password"} />
						</div>
						<ButtonComponent
							border={false}
							size={40} 
						...
						></ButtonComponent>
						<p style={{ marginTop: '8px', fontSize: '13px', color: '#666' }}>Bạn đã có tài khoản? <WrapperTextLight>Đăng nhập</WrapperTextLight></p>
					</WrapperContainerLeft>
